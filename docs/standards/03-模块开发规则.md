...
- 凭据：不落明文，引用 `ConnectionProfile.secretRef`（框架凭证库，系统 keyring 主密钥 + AES-256-GCM；Stronghold 已于 2026-08-24 决策弃用）
...
- [ ] 全量验证（§5）通过后按[21-Git提交规范](21-Git提交规范.md)提交（scope 用插件作用域）
