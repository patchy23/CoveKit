...
首个公开测试版；Windows x64 与 macOS ARM64/x64 安装包待构建及实机验证。应用内更新关闭，macOS 未公证，详细限制见发布说明。

### 新增

- 主窗口 GitHub 入口、设置分区滚动目录与集中展示版本说明和更新的「关于 CoveKit」。
...
未发布变更的功能与平台验证状态见[平台能力矩阵](docs/product/07-平台能力矩阵.md)。以下版本条目保留对应时期的历史记录，不代表当前版本的验证结论。

## 内部开发阶段记录 - 2026-08-24

以下为原 `0.1.0` 开发记录，不代表曾公开发布稳定版。
...
[0.1.0-alpha.1]: https://github.com/patchy23/CoveKit/releases/tag/v0.1.0-alpha.1
