 ...
 * 视图模式：侧栏可折叠（sidebarCollapsed），标题栏可随沉浸模式隐藏（immersive，
 * 隐藏后 ImmersiveBar 悬浮条负责恢复与窗口控制）。
 */
...
import ImmersiveBar from "@/features/ui/ImmersiveBar.vue";
...
<template>
  <div class="relative flex h-screen flex-col overflow-hidden">
    ...
    <ImmersiveBar v-if="ui.immersive" />
    <SettingsModal />
    <Toast />
  </div>
</template>
