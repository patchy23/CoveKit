    ...
    <div v-else-if="section === 'history'" class="space-y-[2px]">
      ...
      >
        <div class="flex items-center gap-[4px]">
          ...
          />
          <span class="text-caption text-text-muted dark:text-text-muted-dark">{{ entry.at }}</span>
    ...
    <div v-else class="space-y-[2px]">
      ...
      >
        <div class="min-w-0 flex-1 cursor-pointer text-left" @click="onSaved(entry)">
          ...
          <div class="line-clamp-2 font-mono text-caption text-secondary dark:text-secondary-dark">
            {{ entry.sql }}
          </div>
        </div>
        <UiIconButton
