  ...
  <div class="max-w-[720px]">
    ...
    <div v-else class="flex flex-col gap-[16px]">
      ...
      >
        ...
        <div class="flex flex-col gap-[10px]">
          <label class="flex flex-col gap-[4px]">
            ...
            <input v-model="aliyun.id" class="field-input font-mono" placeholder="LTAI5t…" spellcheck="false" />
          </label>
          <label class="flex flex-col gap-[4px]">
            <span class="field-label">AccessKey Secret</span>
            <input v-model="aliyun.key" class="field-input font-mono" type="password" placeholder="••••••••" spellcheck="false" />
          </label>
        </div>
      </section>
      ...
      >
        ...
        <p class="mb-[12px] text-body-sm text-text-muted dark:text-text-muted-dark">
          DNSPod API Token（ID + Token）。创建入口：
          <a
            class="text-info-strong underline dark:text-info-dark"
