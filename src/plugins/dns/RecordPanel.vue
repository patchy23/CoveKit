...
<template>
  <div class="flex min-h-0 flex-col gap-[10px]">
    ...
    <!-- 分页 -->
    <div v-if="totalPages > 1" class="flex shrink-0 items-center justify-end gap-[8px] text-body-sm">
      ...
      <button class="btn-ghost px-[10px] py-[5px]" :disabled="page >= totalPages" @click="goto(page + 1)">
        下一页
      </button>
    </div>
  </div>
