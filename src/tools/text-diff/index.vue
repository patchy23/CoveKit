    ...
    <div class="overflow-hidden rounded-md border border-border dark:border-border-dark">
      <div class="flex flex-col">
        <div
          ...
          :key="i"
          class="flex gap-[10px] border-b border-border px-[12px] py-[5px] font-mono text-[12.5px] leading-relaxed last:border-b-0 dark:border-border-dark"
          :class="
            line.type === 'add'
        ...
        <p v-if="!diff.length" class="p-[14px] text-[12.5px] text-text-muted">两侧内容相同或为空</p>
      </div>
    </div>
  </div>
</template>
